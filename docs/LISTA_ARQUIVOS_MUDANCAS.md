...
- [x] **ShopeeProductUrlParser.cs** — extração flexível de ShopId/ItemId (`-i.`, `/product|/item|/universal-link`, query `shopId`/`itemId`) e fallback de homologação (`999999`/`888888`).
